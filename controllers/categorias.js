...
const getItem = async (req, res) => {
  ...
  try {
    ...
    const data = await CategoriasModel.findById(req.params.id); // Busca la categoría por ID
...
const createItem = async (req, res) => {
  ...
  try {
    const data = await CategoriasModel.create(body); // Crea la categoría en la base de datos
...
const updateItem = async (req, res) => {
  try {
    ...
    const data = await CategoriasModel.findOneAndUpdate(
