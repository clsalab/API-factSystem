...
const getItem = async (req, res) => {
  ...
  try {
    ...
    const data = await VentasModel.findById(req.params.id); // Busca la categoría por ID
...
const createItem = async (req, res) => {
  ...
  try {
    const data = await VentasModel.create(body); // Crea la categoría en la base de datos
